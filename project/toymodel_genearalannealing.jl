...
# sa = SimulatedAnnealingHamiltonian(15, 5)
# nbatch = 100
...
# track_temp = track_equilibration_pulse_reverse_gpu!(HeatBath(), Exponentialtype(), sa, state, energy_gradient_exp, 10.0, 1.0, 5000, accelerate_flip = false)

# track_temp = track_equilibration_pulse_reverse_cpu!(HeatBath(), Exponentialtype(), sa, state, energy_gradient_exp, 10.0, 1.0, 5000, accelerate_flip = false)
