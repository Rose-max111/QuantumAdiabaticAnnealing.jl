...
@info "input energy gap is $(energy_gap)"
...
println("pin input", "success_time = ", success_time, "energy_gap = ", energy_gap)
@info "pin input, success_time = $success_time, energy_gap = $energy_gap"
