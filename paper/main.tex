...
\begin{figure}
\centering
%\includesvg{../notes/images/rule110\_transvarient.svg}
\caption{Alt text}
\end{figure}
...
\begin{equation}
    H_{\text{Ryd}} = \sum_v \dfrac{\Omega_v}{2} \sigma^x_v -\sum_v \Delta_v n_v + \sum_{v \textless{} w}  V_{\text{Ryd}}(|\overrightarrow{\mathbf{r}_v} -\overrightarrow{\mathbf{r}_w}|)n_v n_w.
\end{equation}
...
\includegraphics[width=3.125in,height=\textheight,keepaspectratio]{../notes/images/gadgets.png}
...
the circuit satisfiability problem, which is NP-complete.\footnote{Moore,
  Cristopher, and Stephan Mertens. The nature of computation. OUP
  Oxford, 2011.}
