...
Intrigued by the question that how to efficiently thermalize an Ising machine and drive it to the ground state, we propose a new type of TC, which is based on a translational invariant crystalline structure.
